...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void calculateGrade(String scoreInput) {
    ...
    if (score >= 90) { // to calculate the cal
      result = 'A';
    } else if (score >= 80) {
      result = 'B';
    } else if (score >= 70) {
    ...
    return Scaffold(
      ...
      body: Center( // Center the column
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.center, // Horizontally center the content to be in the center
          children: [
            // TextField with % inside and medium width
              SizedBox(height: 20), // Add some space from the app bar to the input field
              ...
              SizedBox(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    prefixIcon: Icon(Icons.percent, color: Colors.pinkAccent), // Pink percentage icon
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(30), // Rounded border
                    ),
                    labelText: 'Type your score',
                    labelStyle: TextStyle(color: Colors.grey), // Neutral label color
                  ),
                  style: TextStyle(fontSize: 18, color: Colors.black), // Black text input
                ),
              ),
              SizedBox(height: 10), 
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.pinkAccent, // Pink button background
                  padding: EdgeInsets.symmetric(vertical: 20.0), // Increase vertical padding for larger button
            ...
            // Result text
            Text(
              result.isEmpty ? '' : result, // Check if result is empty instead of using if statement
